...
<div>
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">+ Crear</button>
                ...
                <div class="row">
                    ...
                    <div class="col col-12 col-md-4">
                        ...
                        <select id="rol" v-model="rol" class="form-select" required>
                            <option value="enc">Encuestador</option>
    ...
    methods: {
        ...
        async createUserByAdmin() {
            ...
            try {
                ...
                const tempPassword = "temporary-password-" + Math.random().toString(36).substring(7);
                const userCredential = await createUserWithEmailAndPassword(auth, this.userEmail, tempPassword);
