    ...
    <div class="container agendamiento mb-4">
      ...
      <div class="row">
        <div class="col-12 col-md-6">
          <h6><i class="bi bi-prescription2"></i> Toma de laboratorios</h6>
          ...
          <div class="row mb-4">
            <div class="col-6">
              <div>
                <label for="fechalab" class="form-label">Fecha</label>
                <input type="date" class="form-control" id="fechalab" v-model="datelab" />
              </div>
            </div>
            ...
            <div class="col-6">
              <div>
                ...
                <select
                  ...
                  v-model="dateConsulta"
                >
                  <option value="">Seleccione fecha disponible</option>
                  <option
                    v-for="(fecha, index) in itemsGrupo"
                    :value="fecha.fecha"
                    :key="index"
                  >
...
export default {
  ...
  methods: {
    ...mapActions(["getAgendas", "getTomamuestras"]),
  },
  computed: {
    ...mapState(["agendas"]),

    itemsGrupo() {
      return this.agendas.filter((item) => item.grupo == this.idgrupo);
    },
  },
  mounted() {
    this.getAgendas();
