        ...
        <div class="row">
          <div class="col-12 col-md-6">
            ...
            <div class="row mb-4">
              <div class="col-6">
                <div>
                  ...
                  >
                    ...
                    <option
                      v-for="(fecha, index) in agendas"
                      :value="{ fecha: fecha.fecha, id: fecha.id }"
                      :key="index"
                    >
              ...
              <button
              class="btn btn-sm btn-warning mb-3 mt-3"
              @click=" guardarAgendamientoTomaLab"
            >
              ...
              <div class="col-6">
                <div>
                  ...
                  <select
                    class="form-select"
                    aria-label="Default select example"
                    v-model="dateIDvisita"
                  >
                    <option value="">Disponibles</option>
                    <option
                      v-for="(fecha, index) in FechasVisitasGrupo"
                      :value="{ fecha: fecha.fecha, id: fecha.id }"
                      :key="index"
                    >
                      {{ fecha.grupo }} - {{ fecha.fecha }}
...
export default {
  ...
  methods: {
    ...mapActions(["getListAgendas", "getTomamuestras", "guardarAgendaT"]),
    ...
    guardarAgendamientoTomaLab() {
      if (this.dateIDlab === "" || this.horalab === "") {
