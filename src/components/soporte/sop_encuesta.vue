    ...
    <div class="container">
      ...
      <div class="container formulario">
        <form @submit.prevent="addRegistroEncuesta">
              ...
              <div class="row">
                <div class="col-10">
                  <select id="tipoActividad" v-model="tipoActividad" class="form-select">
                    ...
                    <option
                      :value="option.nombre"
                      v-for="(option, index) in tipoActividadExtramural"
                      :key="index"
                    >
                      {{ option.nombre }}
                    </option>
                ...
                <div class="col-10">
                  ...
                  >
                    ...
                    <option
                      ...
                      v-for="(option2, index) in poblacionRiesgoOptions"
                      :key="index"
                    >
                      {{ option2.nombre }}
                    </option>
          ...
          <button type="submit" class="btn btn-primary">Guardar Demanda inducida</button>
        </form>
      </div>
    </div>
  </div>
