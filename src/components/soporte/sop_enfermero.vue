<template>
  <div>
      <h1 class="display-6 center">Profesional (enfermero)</h1>
                  ...
                  <table class="table table-striped table-sm">
                      ...
                      <tbody class="table-group-divider">
                          <tr v-for="(encuesta, index) in encuestas" :key="index">
                              <td>Paciente:{{ encuesta.nombre1 }} {{ encuesta.apellido1 }} / {{ encuesta.tipodoc }}{{ encuesta.numdoc }}<hr>
                  ...
                  <table class="table table-striped table-sm">
                      ...
                      <tbody class="table-group-divider">
                          <tr v-for="(encuesta, index) in this.encuestasToday" :key="index">
                              <td>Paciente: {{ encuesta.nombre1 }} {{ encuesta.apellido1 }} / {{ encuesta.tipodoc }}{{ encuesta.numdoc }}<hr> Actividades:{{ encuesta.tipoActividad }} <hr> P Riesgo: {{ encuesta.poblacionRiesgo }}</td>
  ...
  export default {
      ...
      methods: {
          ...mapActions(["removeRegEnc", "getAllRegistersByFechaStatusProf", "getAllRegistersByIduserProf", "getAllRegistersByFechaProf"]),
